...
(function () {
  ...
  const TEXT_MAP = new Map([
    ...
    // ─── DP Control ───
    ['动力定位 — PoseidonX', 'DP Control — PoseidonX'],
    ['緯度', 'Latitude'],
    ['經度', 'Longitude'],
    ['设定值', 'Setpoints'],
    ['设定値', 'Setpoints'],
    ...
    // ─── Energy Compliance ───
    ['能效合规 — PoseidonX', 'Energy Compliance — PoseidonX'],
    ['评级', 'Rating'],
    ['限值', 'Limit'],
    ['监测', 'Monitoring'],
    ...
    // ─── Poseidon Config ───
    ['系统配置 — PoseidonX', 'System Configuration — PoseidonX'],
    ...
    ['你是 PoseidonX 海事智能助手', 'You are PoseidonX Maritime AI Assistant'],
