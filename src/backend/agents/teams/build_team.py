...
def _agent_researcher() -> AgentProfile:
    return AgentProfile(
        ...
        personality=AgentPersonality(
            ...
            expertise_areas=["maritime_domain", "technology_research", "gap_analysis"],
...
def _agent_developer() -> AgentProfile:
    return AgentProfile(
        ...
        personality=AgentPersonality(
            ...
            expertise_areas=["python", "fastapi", "threejs", "maritime_systems"],
...
def create_build_team() -> AgentTeam:
    team = AgentTeam(
        ...
        name="PoseidonX Build System",
        description="AI-native build and development team for PoseidonX",
