# -*- coding: utf-8 -*-
"""PoseidonX Agent Team Framework — Core Data Models.
...
class ToolCategory(Enum):
    ...
    MARITIME = "maritime"
    # Maritime-specific tool categories
...
class SkillCategory(Enum):
    ...
    DIGITAL_TWIN = "digital_twin"
    MARITIME = "maritime"
    # Maritime-specific skill categories
    NAVIGATION = "navigation"
    COLLISION_AVOIDANCE = "collision_avoidance"
    PROPULSION = "propulsion"
    WEATHER_ANALYSIS = "weather_analysis"
    CARGO_MANAGEMENT = "cargo_management"
    SHIP_COMMUNICATION = "ship_communication"
...
# ── Maritime Domain Constants ──────────────────────────────────────────────


class MASSLevel(Enum):
    """IMO Maritime Autonomous Surface Ships (MASS) Degree of Autonomy.

    Per IMO MSC.107(98) / MSC 105 Interim Guidelines.
    """

    DEGREE_1 = 1  # Crew on board, automated processes & decision support
    DEGREE_2 = 2  # Remotely controlled with crew on board
    DEGREE_3 = 3  # Remotely controlled without crew on board
    DEGREE_4 = 4  # Fully autonomous
...
COLREGS_RULES = {
    ...
    19: "Conduct in restricted visibility",
}
