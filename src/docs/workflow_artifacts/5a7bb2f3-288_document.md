...
任务: 给build团队的PM发一个任务，给http://localhost:5173/cms-health.html添加chat功能，并且对话智能体可以进行选择，智能体的LLM模型可用的高亮显示其名称
步骤: document
...
📝 提示词:
  ...
  ## 任务
  给build团队的PM发一个任务，给http://localhost:5173/cms-health.html添加chat功能，并且对话智能体可以进行选择，智能体的LLM模型可用的高亮显示其名称
  给build团队的PM发一个任务，给http://localhost:5173/cms-health.html添加chat功能，并且对话智能体可以进行选择，智能体的LLM模型可用的高亮显示其名称
