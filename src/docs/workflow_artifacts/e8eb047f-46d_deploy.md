...
任务: 给build团队的PM发一个任务，优化navigation-v2.html页面的所有功能，连续4个小时，是navigation-v2.html页面的所有功能
步骤: deploy
...
📝 提示词:
  ...
  ## 任务
  给build团队的PM发一个任务，优化navigation-v2.html页面的所有功能，连续4个小时，是navigation-v2.html页面的所有功能
  给build团队的PM发一个任务，优化navigation-v2.html页面的所有功能，连续4个小时，是navigation-v2.html页面的所有功能
