...
任务: 给build团队的PM发一个任务就是本页面K-Chief 700 CMS — Condition Monitoring的设备树不能选择，点击后页面数值没有变化
步骤: deploy
...
📝 提示词:
  ...
  ## 任务
  给build团队的PM发一个任务就是本页面K-Chief 700 CMS — Condition Monitoring的设备树不能选择，点击后页面数值没有变化
  给build团队的PM发一个任务就是本页面K-Chief 700 CMS — Condition Monitoring的设备树不能选择，点击后页面数值没有变化
